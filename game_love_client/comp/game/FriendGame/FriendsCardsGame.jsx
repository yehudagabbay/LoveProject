...
// --- קבועים ועזרים ---
// כאן נתת לנו בעבר סגנונות שונים לחברים (כיף/גיבוש)
const CAT_COLORS = { 1: '#059669', 2: '#F59E0B', 3: '#6366F1' };
const categoryName = (id) =>
  id === 1 ? 'היכרות / שיתוף' : id === 2 ? 'כיף וצחוקים' : 'גיבוש / עומק';
const levelName = (id) =>
...
const CATEGORY_THEME = {
  ...
  2: { name: 'Friends Fun', bgColor: '#FEF3C7', icon: iconFun },
  3: { name: 'Friends Bond', bgColor: '#E0E7FF', icon: iconLove },
};
...
export default function FriendsCardsGame({ route, navigation }) {
  ...
  // שמות השחקנים – במשחק חברים אין ברירת מחדל, רק מה שהוזן במסך הבחירה
  ...
  const handleDrawPress = () => {
    if (remainingCount === 0) {
      Alert.alert(
        'נגמרו הקלפים',
        'שיחקתם בכל הקלפים. חזרו לבחירת קלפים למשחק חברים חדש.',
        [
          {
            text: 'לבחירת קלפים',
            onPress: () =>
  ...
  return (
    <View style={styles.screen}>
      ...
      <View style={styles.header}>
        <Text style={styles.gameTitle}>משחק חברים / עבודה</Text>
        <Text style={styles.gameSubTitle}>
          מכירים אחד את השני בדרך משחקית 🎉
        </Text>
      </View>
          ...
          {remainingCount > 0 ? (
            ...
            <View style={styles.emptyBox}>
              ...
              <Text style={styles.emptySub}>
                חזרו לבחירת הקלפים כדי להתחיל משחק חברים חדש.
              </Text>
            </View>
          )}
        </View>
